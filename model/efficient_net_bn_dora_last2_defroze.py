...
GENERATED_SPEC = {'model_name': 'efficient_net_bn_dora_last2_defroze', 'base_provider': 'torchvision', 'base_family': 'efficientnet', 'variant': 'efficientnet_v2_s', 'base_model': 'efficientnet_v2_s', 'task_type': 'classification', 'method_type': 'dora', 'freeze_strategy': 'bn_tuning_with_last_stages', 'train_bn': True, 'train_norm': False, 'unfreeze_stages': [6, 7], 'peft_method': 'dora', 'peft_targets': {'feature_stages': [7], 'layer_keys': [], 'classifier': False}, 'peft_params': {'rank': 8, 'alpha': 16.0}, 'stage_lr_overrides': {}, 'gradcam_target_hint': ['features.7'], 'pretrained': True, 'metadata_version': '1.3', 'generator_version': 'phase_canvas_methods_v1', 'is_generated': True, 'source_of_truth': 'spec', 'spec_name': 'efficient_net_bn_dora_last2_defroze.json', 'spec_file': 'model_specs/efficient_net_bn_dora_last2_defroze.json', 'source_spec_file': 'model_specs/efficient_net_bn_dora_last2_defroze.json'}
