...
GENERATED_SPEC = {'model_name': 'efficientnet_tsa_gen', 'base_model': 'efficientnet_v2_s', 'task_type': 'classification', 'method_type': 'tsa', 'freeze_strategy': 'frozen_backbone_peft', 'train_bn': False, 'unfreeze_stages': [], 'peft_method': 'tsa', 'peft_targets': {'feature_stages': [5, 6, 7], 'layer_keys': [], 'classifier': True}, 'peft_params': {}, 'gradcam_target_hint': ['features.7'], 'pretrained': True, 'metadata_version': '1.1', 'generator_version': 'phase3_v1'}
