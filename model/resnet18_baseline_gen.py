...
GENERATED_SPEC = {'model_name': 'resnet18_baseline_gen', 'base_model': 'resnet18', 'task_type': 'classification', 'method_type': 'baseline', 'freeze_strategy': 'linear_probe', 'train_bn': False, 'unfreeze_stages': [], 'peft_method': None, 'peft_targets': {'feature_stages': [], 'layer_keys': [], 'classifier': False}, 'peft_params': {}, 'gradcam_target_hint': ['layer4'], 'pretrained': True, 'metadata_version': '1.1', 'generator_version': 'phase3_v1'}
