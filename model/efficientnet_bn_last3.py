...
GENERATED_SPEC = {'model_name': 'efficientnet_bn_last3', 'base_provider': 'torchvision', 'base_family': 'efficientnet', 'variant': 'efficientnet_v2_s', 'base_model': 'efficientnet_v2_s', 'task_type': 'classification', 'method_type': 'bn_tuning', 'freeze_strategy': 'bn_tuning', 'train_bn': True, 'train_norm': False, 'unfreeze_stages': [5, 6, 7], 'peft_method': None, 'peft_targets': {'feature_stages': [], 'layer_keys': [], 'classifier': False}, 'peft_params': {}, 'stage_lr_overrides': {}, 'gradcam_target_hint': ['features.7'], 'pretrained': True, 'metadata_version': '1.3', 'generator_version': 'phase_canvas_methods_v1', 'is_generated': True, 'source_of_truth': 'spec', 'spec_name': 'efficientnet_bn_last3.json', 'spec_file': 'model_specs/efficientnet_bn_last3.json', 'source_spec_file': 'model_specs/efficientnet_bn_last3.json'}
