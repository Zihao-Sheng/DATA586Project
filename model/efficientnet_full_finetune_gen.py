...
GENERATED_SPEC = {'model_name': 'efficientnet_full_finetune_gen', 'base_model': 'efficientnet_v2_s', 'task_type': 'classification', 'method_type': 'full_finetune', 'freeze_strategy': 'full_finetune', 'train_bn': False, 'unfreeze_stages': [], 'peft_method': None, 'peft_targets': {'feature_stages': [], 'layer_keys': [], 'classifier': False}, 'peft_params': {}, 'gradcam_target_hint': ['features.7'], 'pretrained': True, 'metadata_version': '1.1', 'generator_version': 'phase3_v1'}
