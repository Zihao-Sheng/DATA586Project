...
GENERATED_SPEC = {'model_name': 'efficientnet_bn_last2_gen', 'base_model': 'efficientnet_v2_s', 'task_type': 'classification', 'method_type': 'bn_last2', 'freeze_strategy': 'bn_tuning_with_last_stages', 'train_bn': True, 'unfreeze_stages': [6, 7], 'peft_method': None, 'peft_targets': {'feature_stages': [], 'layer_keys': [], 'classifier': False}, 'peft_params': {}, 'gradcam_target_hint': ['features.7'], 'pretrained': True, 'metadata_version': '1.1', 'generator_version': 'phase3_v1'}
